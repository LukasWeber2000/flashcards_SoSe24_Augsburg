...
List<Flashcard> flashcards = [
  Flashcard(question: 'What is the capital of France?', answer: 'Paris', interval: 1.2, ease: 2.7, deck: 'Geography',dueDate: DateTime.now()),
  Flashcard(question: 'Who wrote "To Kill a Mockingbird"?', answer: 'Harper Lee', interval: 1.3, ease: 2.8, deck: 'Literature',dueDate: DateTime.now()),
  Flashcard(question: 'What is the chemical symbol for water?', answer: 'H2O', interval: 1.4, ease: 2.6, deck: 'Science',dueDate: DateTime.now()),
  Flashcard(question: 'What is the powerhouse of the cell?', answer: 'Mitochondria', interval: 1.5, ease: 2.9, deck: 'Biology',dueDate: DateTime.now()),
  Flashcard(question: 'What is the currency of Japan?', answer: 'Yen', interval: 1.6, ease: 2.5, deck: 'Economics',dueDate: DateTime.now()),
  Flashcard(question: 'Who painted the Mona Lisa?', answer: 'Leonardo da Vinci', interval: 1.7, ease: 2.8, deck: 'Art',dueDate: DateTime.now()),
  Flashcard(question: 'What is the largest planet in our solar system?', answer: 'Jupiter', interval: 1.8, ease: 2.7, deck: 'Astronomy',dueDate: DateTime.now()),
  Flashcard(question: 'Which country is known as the Land of the Rising Sun?', answer: 'Japan', interval: 1.9, ease: 2.6, deck: 'Geography',dueDate: DateTime.now()),
  Flashcard(question: 'Who is the Greek god of the sea?', answer: 'Poseidon', interval: 2.0, ease: 3.0, deck: 'Mythology',dueDate: DateTime.now()),
  Flashcard(question: 'What is the chemical formula for table salt?', answer: 'NaCl', interval: 2.1, ease: 2.8, deck: 'Chemistry',dueDate: DateTime.now()),
